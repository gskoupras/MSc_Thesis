...
hist = gru.fit(X_train, y_train, epochs=epoch, verbose=1, batch_size=batch_s,
...
axes.set_title('GRU (Real vs Predicted values)',
               fontsize=18)
...
np.savetxt('GRU_y_test.csv', y_test, delimiter=",")
np.savetxt('GRU_y_pred.csv', y_pred, delimiter=",")
