...
time_st = 144  # SPs to look back to predict the price in next day
...
for i in params[list(params)[0]]:
    ...
    lstm.compile(loss='mae', optimizer=i,
                 metrics=['mse', 'mae'])
