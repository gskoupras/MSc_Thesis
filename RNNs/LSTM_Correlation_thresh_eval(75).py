# =============================================================================
# LSTM_Correlation_thresh_eval.py
# =============================================================================
import pandas as pd
import numpy as np
import time
...
axes.text(np.argmin(mae)-0.12, min(mae)+0.03, str(min(mae)), fontsize=16)
for i in range(0, max_thresh):
...
axes2.text(np.argmin(rmse)-0.22, min(rmse)+0.04, str(min(rmse)), fontsize=16)
