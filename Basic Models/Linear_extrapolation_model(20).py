...
axes.plot(range(len(y)), y_pred, zorder=2, lw=3,
          color='blue', label='Linear Extrapolation')
axes.plot(range(len(y)), y_pred.iloc[:, 0]-y, zorder=0, lw=3,
          color='green', label='Model Residual Error')
axes.set_title('Linear Extrapolation Model Behaviour', fontsize=18)
...
#          color='blue')
#axes.set_title('Linear Extrapolation Model Behaviour - Residuals',
#               fontsize=18)
#axes.set_xlabel('Day and SP', fontsize=16)
