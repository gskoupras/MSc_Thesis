# =============================================================================
# Correlation_system_features.py
# =============================================================================
import pandas as pd
import numpy as np
...
axes.set_title('Correlation of System Features with Offer Prices', fontsize=18)
axes.legend(loc='upper left', fontsize=14)
axes.grid(True)
axes.autoscale()
# fig.savefig('Correlation bar chart: system features',
#             bbox_inches='tight', dpi=800)
...
ax.set_title('Correlation Matrix: System Features', fontsize=20)
plt.yticks(rotation=0, fontsize=18)
plt.xticks(fontsize=18)
plt.show()
# plt.savefig('Correlation heat map: System Features',
#             bbox_inches='tight', dpi=800)
