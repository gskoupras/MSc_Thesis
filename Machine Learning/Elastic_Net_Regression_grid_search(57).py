# =============================================================================
# Elastic_Net_Regression_grid_search.py
# =============================================================================
import pandas as pd
import numpy as np
...
#params = {
#        "alpha": list(range(100, 800, 10)),
#        "l1 ratio": np.around(list(np.arange(0.001, 0.101, 0.001)), 3)}

params = {
        "alpha": list(range(1, 102, 5)),
        "l1 ratio": np.around(list(np.arange(0.01, 1, 0.01)), 4)}
...
ax.set_title('Elastic Net', fontsize=16, pad=20)
