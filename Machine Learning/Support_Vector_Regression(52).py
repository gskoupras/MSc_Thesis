...
# Based on BE on MAE
data = data.loc[:, ['Ren_R', 'APXP', 'Im_Pr', 'LOLP', 'Gr1', 'Ret', 'Gr2',
                     'Prev', 'SMA20', 'SRSID', 'BB', 'BBw',
                     'Spk', 'Med', 'Offers']]
...
# svr = SVR(C=1, kernel='rbf', gamma='scale', epsilon=15, verbose=1)
...
axes.set_title('Support Vector Regression',
               fontsize=18)
