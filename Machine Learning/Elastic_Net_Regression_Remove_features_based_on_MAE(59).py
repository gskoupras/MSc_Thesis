# =============================================================================
# Elastic_Net_Regression_Remove_features_based_on_MAE.py
# =============================================================================
import pandas as pd
import numpy as np
import time
...
en = ElasticNet(alpha=6, l1_ratio=0.99)
...
while terminal == 1:
    ...
    for i in range(0, len(features)):
        ...
        X_train_norm = (X_train-X_train.mean())/X_train.std()
        X_test_norm = (X_test_temp-X_train.mean())/X_train.std()
...
axes2.annotate(str(min(rmse_evo)),
               ...
               xytext=(np.argmin(rmse_evo), min(rmse_evo)+0.09),
               textcoords='data',
               arrowprops=dict(arrowstyle="<-", facecolor='black'),
               horizontalalignment='center', verticalalignment='top',
               fontsize=16)
