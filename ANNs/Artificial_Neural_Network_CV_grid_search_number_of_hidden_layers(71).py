# =============================================================================
# Artificial_Neural_Network_CV_grid_search_number_of_hidden_layers.py
# =============================================================================
import pandas as pd
import numpy as np
...
def build_regressor(n_layers, n_neurons=8, optimizer='Adagrad'):
    nn = Sequential()
...
print('The minimum RMSE is given for',
      grid.cv_results_['param_n_layers']
...
params = grid.cv_results_['param_n_layers']
...
axes.set_title('Effect of Number of Hidden Layers on '
...
axes.grid(True)
axes.autoscale()
# fig.savefig('Effect of Number of Hidden Layers on '
#             'Artificial Neural Network Performance',
