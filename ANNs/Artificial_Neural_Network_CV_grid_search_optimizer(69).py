# =============================================================================
# Artificial_Neural_Network_CV_grid_search_optimizer.py
# =============================================================================
import pandas as pd
import numpy as np
...
def build_regressor(optimizer, n_neurons=14, n_layers=7):
    nn = Sequential()
...
nn = KerasRegressor(build_fn=build_regressor, batch_size=100, epochs=30)
...
for i in range(0, len(params)):
    parameters = np.append(parameters, params[i].get('optimizer'))
...
for i in range(0, len(parameters)):
    axes.scatter(i,
                 ...
                 marker="o", s=size, label=parameters[i])
...
axes.grid(True)
axes.autoscale()
# fig.savefig('Effect of Optimizer Method on '
#             'Artificial Neural Network Performance',
