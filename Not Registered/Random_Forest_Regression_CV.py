# =============================================================================
# Random_Forest_Regression_CV.py
# =============================================================================
import pandas as pd
import numpy as np
...
#data = data.loc[:, ['Ren_R', 'APXP', 'TSDF', 'NIV', 'In_gen', 'Gr1', 'Ret', 
#                    'Gr2', 'SMA20', 'EMA10', 'BB', 'Offers']]

# Based on BE on RMSE (CV)
data = data.loc[:, ['Ren_R', 'TSDF', 'NIV', 'Im_Pr', 'In_gen', 'Gr1', 'Ret',
                    'Gr2', 'Prev', 'SMA20', 'BBw', 'Med', 'Offers']]
